    ...
    return {
        init: function () {
            ...
            jQuery("#menu").length > 0 && $("#menu").metisMenu(),
                jQuery(".metismenu > .mm-active ").each(function () {
                    !jQuery(this)
                        .children("ul")
                        .length > 0 && jQuery(this).addClass("active-no-child")
                }),
                ...
                (
                    (n = window.outerHeight) > 0
                        ? n
                        : screen.height
                ) && $(".content-body").css("min-height", n - 160 + "px"),
                        ...
                        : document.documentElement.requestFullscreen
                            ...
                            : document.documentElement.webkitRequestFullscreen
                                ...
                                : document.documentElement.mozRequestFullScreen
                                    ...
                                    : document.documentElement.msRequestFullscreen && document
                                        .documentElement
                                        .msRequestFullscreen()
                }),
                jQuery(".show-pass").on("click", function () {
                    jQuery(this).toggleClass("active"),
                        "password" == jQuery("#dlab-password").attr("type")
                            ...
                            : "text" == jQuery("#dlab-password").attr("type") && jQuery("#dlab-password").attr(
                                "type",
                                "password"
                            )
                }),
        ...
        handleMenuPosition: function () {
            e > 1024 && $(".metismenu  li")
                ...
                .each(function (e) {
                    if ($("ul", this).length > 0) {
                        var t = (a = $("ul:first", this).css("display", "block"))
                            .offset()
                            .left,
                            n = a.width(),
