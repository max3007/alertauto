/* ! FilePond 4.30.4 Licensed under MIT, https://opensource.org/licenses/MIT/
...
!function (e, t) {
    ...
    var t = function (e, t) {
        ...
        O = function (e, t) {
            var n = t.opacity,
                ...
                _ = "",
                T = "";
            (h(f) || h(d)) && (T += "transform-origin: " + (
                f || 0
            ) + "px " + (
                    d || 0
                ) + "px;"),
                h(r) && (_ += "perspective(" + r + "px) "),
                (h(o) || h(i)) && (_ += "translate3d(" + (
                    o || 0
                ) + "px, " + (
                        i || 0
                    ) + "px, 0) "),
        ...
        A = function (e, t) {
            return function (n) {
                ...
                a
                    ...
                    .forEach(function (t) {
                        return e[t.type](
                            { root: r, props: o, action: t.data, timestamp: s, shouldOptimize: u }
                        )
                    }),
        ...
        j = function (e, t, n, r, o) {
            ...
            return i.withCredentials = G(i.withCredentials),
                i
        },
        H = function (e) {
                ...
                : function (e) {
                    ...
                    : V(e)
                        ...
                        : /^[0-9]+ ?(?:GB|MB|KB)$/gi.test(e)
                            ? "bytes"
                            : function (e) {
                                return H(e) && U(e.url) && H(e.process) && H(e.revert) && H(e.restore) && H(
                                    e.fetch
                                )
                            }(e)
                                ? "api"
        ...
        z = function (e, t, n) {
            ...
            if (o !== n) {
                var i = (r = e, W[n](r));
                if (o = X(i), null === i)
                    throw 'Trying to assign value with incorrect type to "' + option + '", allowed ' +
                    'type: "' + n + '"';
                e = i
            }
            return e
    ...
    var ce,
        ...
        pe = function () {
            ...
            return {
                fireSync: function (e) {
                    for (var t = arguments.length, r = new Array(
                        t > 1
                            ? t - 1
                            : 0
                    ), o = 1; o < t; o++)
        ...
        Ae = {
            ...
            labelIdle: [
                'Drag & Drop your files or <span class="filepond--label-action">Browse</span>', ge.STRING
            ],
            labelInvalidField: [
                "Field contains invalid files", ge.STRING
            ],
            labelFileWaitingForSize: [
                "Waiting for size", ge.STRING
            ],
            labelFileSizeNotAvailable: [
                "Size not available", ge.STRING
            ],
            labelFileCountSingular: [
                "file in list", ge.STRING
            ],
            labelFileCountPlural: [
                "files in list", ge.STRING
            ],
            labelFileLoading: [
                "Loading", ge.STRING
            ],
            ...
            labelFileLoadError: [
                "Error during load", ge.STRING
            ],
            labelFileRemoved: [
                "Removed", ge.STRING
            ],
            labelFileRemoveError: [
                "Error during remove", ge.STRING
            ],
            labelFileProcessing: [
                "Uploading", ge.STRING
            ],
            labelFileProcessingComplete: [
                "Upload complete", ge.STRING
            ],
            labelFileProcessingAborted: [
                "Upload cancelled", ge.STRING
            ],
            labelFileProcessingError: [
                "Error during upload", ge.STRING
            ],
            labelFileProcessingRevertError: [
                "Error during revert", ge.STRING
            ],
            labelTapToCancel: [
                "tap to cancel", ge.STRING
            ],
            labelTapToRetry: [
                "tap to retry", ge.STRING
            ],
            labelTapToUndo: [
                "tap to undo", ge.STRING
            ],
            ...
            iconRemove: [
                '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/' +
                'svg"><path d="M11.586 13l-2.293 2.293a1 1 0 0 0 1.414 1.414L13 14.414l2.293 2.' +
                '293a1 1 0 0 0 1.414-1.414L14.414 13l2.293-2.293a1 1 0 0 0-1.414-1.414L13 11.58' +
                '6l-2.293-2.293a1 1 0 0 0-1.414 1.414L11.586 13z" fill="currentColor" fill-rule' +
                '="nonzero"/></svg>',
                ge.STRING
            ],
            iconProcess: [
                '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/' +
                'svg"><path d="M14 10.414v3.585a1 1 0 0 1-2 0v-3.585l-1.293 1.293a1 1 0 0 1-1.4' +
                '14-1.415l3-3a1 1 0 0 1 1.414 0l3 3a1 1 0 0 1-1.414 1.415L14 10.414zM9 18a1 1 0' +
                ' 0 1 0-2h8a1 1 0 0 1 0 2H9z" fill="currentColor" fill-rule="evenodd"/></svg>',
                ge.STRING
            ],
            iconRetry: [
                '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/' +
                'svg"><path d="M10.81 9.185l-.038.02A4.997 4.997 0 0 0 8 13.683a5 5 0 0 0 5 5 5' +
                ' 5 0 0 0 5-5 1 1 0 0 1 2 0A7 7 0 1 1 9.722 7.496l-.842-.21a.999.999 0 1 1 .484' +
                '-1.94l3.23.806c.535.133.86.675.73 1.21l-.804 3.233a.997.997 0 0 1-1.21.73.997.' +
                '997 0 0 1-.73-1.21l.23-.928v-.002z" fill="currentColor" fill-rule="nonzero"/><' +
                '/svg>',
                ge.STRING
            ],
            iconUndo: [
                '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/' +
                'svg"><path d="M9.185 10.81l.02-.038A4.997 4.997 0 0 1 13.683 8a5 5 0 0 1 5 5 5' +
                ' 5 0 0 1-5 5 1 1 0 0 0 0 2A7 7 0 1 0 7.496 9.722l-.21-.842a.999.999 0 1 0-1.94' +
                '.484l.806 3.23c.133.535.675.86 1.21.73l3.233-.803a.997.997 0 0 0 .73-1.21.997.' +
                '997 0 0 0-1.21-.73l-.928.23-.002-.001z" fill="currentColor" fill-rule="nonzero' +
                '"/></svg>',
                ge.STRING
            ],
            iconDone: [
                '<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/' +
                'svg"><path d="M18.293 9.293a1 1 0 0 1 1.414 1.414l-7.002 7a1 1 0 0 1-1.414 0l-' +
                '3.998-4a1 1 0 1 1 1.414-1.414L12 15.586l6.294-6.293z" fill="currentColor" fill' +
                '-rule="nonzero"/></svg>',
                ge.STRING
            ],
            oninit: [
        ...
        Le = function (e, t) {
            return M(t)
                ...
                : V(t)
                    ? e[t] || null
                    : ("object" == typeof t && (t = t.id), e.find(function (e) {
                        return e.id === t
                    }) || null)
        },
        be = function (e) {
        ...
        we = null,
        Ce = [
            Ie.LOAD_ERROR, Ie.PROCESSING_ERROR, Ie.PROCESSING_REVERT_ERROR
        ],
        Ne = [
            Ie.LOADING, Ie.PROCESSING, Ie.PROCESSING_QUEUED, Ie.INIT
        ],
                    ...
                    return e.options.storeAsFile && function () {
                        if (null === we)
                            try {
                                ...
                                e
                                    .items
                                    .add(new File(["hello world"], "This_Works.txt"));
        ...
        Xe = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : new Date;
            return e.getFullYear() + "-" + He(e.getMonth() + 1, "00") + "-" + He(
                e.getDate(),
                "00"
            ) + "_" + He(e.getHours(), "00") + "-" + He(e.getMinutes(), "00") + "-" + He(
                e.getSeconds(),
                "00"
            )
        },
        ...
        rt = function (e, t, n) {
            ...
            n = Object.assign({
                ...
                t = encodeURI(t),
                nt(n.method) && e && (t = "" + t + encodeURIComponent(
                    "string" == typeof e
                        ? e
                        : JSON.stringify(e)
                ));
            ...
            return (
                ...
                a.onreadystatechange = function () {
                    a.readyState < 2 || 4 === a.readyState && 0 === a.status || i || (
                        i = !0,
                        r.onheaders(a)
                    )
                },
            ...
            return function (o, i, a, s, u, l) {
                ...
                return c.onload = function (e) {
                    ...
                    c.onerror = function (e) {
                        a(
                            ot("error", e.status, r(e.response) || e.statusText, e.getAllResponseHeaders())
                        )
                    },
        ...
        Et = function (e, t, n, r, o, i, a, s, u, l, c) {
                            ...
                            c.onload = function () {
                                ...
                                c.onerror = function (e) {
                                    t.status = dt,
                                        ...
                                        P(t) || a(
                                            ot("error", e.status, o(e.response) || e.statusText, e.getAllResponseHeaders())
                                        )
                                },
            ...
            return T.serverId
                ? (
                    ...
                    S = {
                        headers: "function" == typeof t.headers
                ...
                : function (i) {
                    ...
                    var u = "function" == typeof t.headers
                        ? t.headers(r, o)
                            ...
                            if (o) {
                                ...
                                return h.onload = function (e) {
                                    ...
                                    h.onerror = function (e) {
                                        s(
                                            ot("error", e.status, T(e.response) || e.statusText, e.getAllResponseHeaders())
                                        )
                                    },
                                    h.ontimeout = it(s),
                                    h.onprogress = u,
                ...
                f = Object.assign({
                    ...
                    revert: function (e, t) {
                        return new Promise(function (n, r) {
                            var o = null !== i.serverFileReference
                                ? i.serverFileReference
                                : i.transferId;
                            null !== o
                                ? (e(o, function () {
            ...
            return {
                            ...
                            if (t("IS_ASYNC")) {
                                ...
                                return r.status === Ie.PROCESSING_COMPLETE
                                    ? (
                                        ...
                                        void r.revert(Tt(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(
                                            s
                                                ? u
                                                : function () { }
                                        ).catch(function () { })
                ...
                MOVE_ITEM: function (e) {
                    ...
                    if (o) {
                        var i = n
                            .items
                            .indexOf(o);
                        i !== (r = xe(r, 0, n.items.length - 1)) && n
                            .items
                            .splice(r, 0, n.items.splice(i, 1)[0])
                    }
                },
                SORT: function (r) {
                    var o = r.compare;
                    ...
                    if (M(o))
                        ...
                        if (!function (e) {
                            ...
                            if (_.status === Ie.PROCESSING_COMPLETE || _.status === Ie.PROCESSING_REVERT_ERROR) {
                                ...
                                if (
                                    _.revert(Tt(n.options.server.url, n.options.server.revert), T).then(function () {
                                        T && e("ADD_ITEM", {
                                            source: o,
                                            index: a,
                                            interactionMethod: s,
                        ...
                        v.load(o, tt(
                            I === ve.INPUT
                                ? U(o) && function (e) {
                                    return (e.indexOf(":") > -1 || e.indexOf("//") > -1) && yt(location.href) !== yt(
                                        e
                                    )
                                }(o) && D
                                    ? ut(R, D)
                ...
                COMPLETE_LOAD_ITEM: function (r) {
                    ...
                    if (Y(u) && s && Lt(n, u), e("DID_LOAD_ITEM", {
                        id: o.id,
                        error: null,
                        serverFileReference: o.origin === ve.INPUT
                            ? null
                            : s
                    }), a(Te(o)), o.origin !== ve.LOCAL)
                        return o.origin === ve.LIMBO
                            ...
                            : void (
                                t("IS_ASYNC") && n.options.instantUpload && e("REQUEST_ITEM_PROCESSING", { query: o.id })
                            );
                    ...
                    if (t("GET_ITEMS_BY_STATUS", Ie.PROCESSING).length !== a) {
                        if (r.status !== Ie.PROCESSING) {
                            ...
                            r.onOnce("process-complete", function () {
                                ...
                                t("GET_ITEMS_BY_STATUS", Ie.PROCESSING_COMPLETE).length === n.items.length && e(
                            ...
                            var u = n.options;
                            r.process(
                                vt(_t(u.server.url, u.server.process, u.name, {
                        ...
                        n
                            .processingQueue
                            .push({ id: r.id, success: o, failure: i })
                }),
                ...
                REMOVE_ITEM: bt(n, function (r, o, i, a) {
                    ...
                    r.origin === ve.LOCAL && u && Y(u.remove) && !1 !== a.remove
                        ...
                        : (
                            (a.revert && r.origin !== ve.LOCAL && null !== r.serverId || n.options.chunkUploads && r.file.size > n.options.chunkSize || n.options.chunkUploads && n.options.chunkForce) && r.revert(Tt(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")),
                            s()
                        )
                }),
        ...
        Ft = S({
            ...
            mixins: {
                apis: ["label"],
                styles: [
                    "translateX", "translateY", "scaleX", "scaleY", "opacity"
                ],
                animations: {
                    scaleX: "spring",
                    scaleY: "spring",
        ...
        kt = S({
            ...
            ignoreRectUpdate: !0,
            write: A(
                { DID_LOAD_ITEM: xt, DID_UPDATE_ITEM_META: xt, DID_THROW_ITEM_LOAD_ERROR: Yt, DID_THROW_ITEM_INVALID: Yt }
            ),
    ...
    var Kt,
        ...
        cn = S({
            create: function (e) {
                ...
                I
                    .element
                    .classList
                    .add("filepond--process-indicator"),
            ...
            write: function (e) {
                ...
                if (i) {
                    ...
                    t(rn, function (e, r) {
                        var o = n.ref[e];
                        t(r, function (t, r) {
                            var i = a[e] && void 0 !== a[e][t]
                                ? a[e][t]
                                : r;
                            n
                                .ref
                                .activeStyles
                                .push({ control: o, key: t, value: i })
                        })
                    })
                }
                n
        ...
        En = S({
            ...
            write: function (e) {
                var t = e.root,
                    n = e.props;
                if (null !== t.ref.scalable && n.scalable === t.ref.scalable || (
        ...
        vn = A({
            ...
            var t = e.root,
                ...
                r = e.props,
                o = e.shouldOptimize;
            "drop" === t.element.dataset.dragState && t.scaleX <= 1 && (
            ...
            a
                ...
                : (
                    ...
                    !t.height && t.ref.container.rect.element.height > 0 && (t.height = t.ref.container.rect.element.height)
                ),
        ...
        mn = S({
            create: function (e) {
                ...
                t.ref.handleClick = function (e) {
                    ...
                    t
                        .element
                        .addEventListener("click", t.ref.handleClick),
            ...
            destroy: function (e) {
                ...
                t
                    .element
                    .removeEventListener("click", t.ref.handleClick),
        ...
        gn = function (e, t, n) {
            if (n) {
                var r = e.rect.element.width,
                    o = t.length,
                    i = null;
                if (0 === o || n.top < t[0].rect.element.top)
                    return -1;
        ...
        On = function (e, t, n) {
            ...
            e.dragOffset
                ...
                : (
                    e.translateX = t,
                    e.translateY = n,
                    Date.now() > e.spawnDate && (0 === e.opacity && yn(e, t, n, r, o), e.scaleX = 1, e.scaleY = 1, e.opacity = 1)
                )
        },
        ...
        Sn = A({
            DID_ADD_ITEM: function (e) {
                ...
                t.ref.lastItemSpanwDate = s,
                    t.appendChildView(t.createChildView(mn, {
                        spawnDate: s,
                        id: r,
                        opacity: u,
                        interactionMethod: i
                ...
                if (0 !== u.length) {
                    ...
                    if (1 === m) {
                        ...
                        u.forEach(function (e, t) {
                            t === l && (f = 1),
                                t === c && (p += 1),
                                e.markedForRemoval && e.opacity < .5 && (d -= 1);
                            var n = t + p + f + d,
                                r = n % m,
                                i = Math.floor(n / m),
                                a = r * I,
        ...
        Mn = function (e) {
            var t = e.root,
                n = e.action;
            t.query("GET_ALLOW_SYNC_ACCEPT_ATTRIBUTE") && Pn(
                t.element,
                "accept",
                !!n.value,
                n.value
            ...
            create: function (e) {
                ...
                t.element.id = "filepond--browser-" + n.id,
                    ...
                    t.ref.handleChange = function (e) {
                        if (t.element.value) {
                            var r = Array
                                .from(t.element.files)
                                .map(function (e) {
                                    return e._relativePath = e.webkitRelativePath,
                                        e
                                });
                            setTimeout(function () {
                                n.onload(r),
                    ...
                    t
                        .element
                        .addEventListener("change", t.ref.handleChange)
            },
            destroy: function (e) {
                var t = e.root;
                t
                    .element
                    .removeEventListener("change", t.ref.handleChange)
            },
            write: A({
                DID_LOAD_ITEM: Bn,
                DID_REMOVE_ITEM: Bn,
        ...
        Yn = S({
            ...
            destroy: function (e) {
                ...
                t
                    .ref
                    .label
                    .addEventListener("keydown", t.ref.handleKeyDown),
                    t
                        .element
                        .removeEventListener("click", t.ref.handleClick)
            },
            ...
            try {
                ...
                t.forEach(function (e) {
                    e instanceof File
                        ...
                        : n
                            .items
                            .add(new File([e], e.name, { type: e.type }))
                }),
                    e.files = n.files
            } catch (e) {
                return !1
        ...
        Zn = A({
            ...
            DID_ADD_ITEM: function (e) {
                var t = e.root,
                    n = e.action,
                    r = !(t.query("GET_ITEM", n.id).origin === ve.LOCAL) && t.query(
                        ...
                        .then(function (e) {
                            ...
                            e.forEach(function (e) {
                                ...
                                t(n.filter(function (e) {
                                    ...
                                    return e._relativePath || (e._relativePath = e.webkitRelativePath),
                                        e
                                }))
                        })
                        .catch(console.error)
                    ...
                    return n.push(a),
                        function () {
                            n.splice(n.indexOf(a), 1),
                                0 === n.length && (_r.splice(_r.indexOf(i), 1), t(r, function (t) {
        ...
        mr = function (e, t) {
            var n,
                r = function (e, t) {
                    return "elementFromPoint" in e || (e = document),
        ...
        Sr = function (e, t, n) {
            ...
            var r = n.catchesDropsOnPage,
                ...
                s = function (e, t, n) {
                    ...
                    return o.destroy = r.addListener(o),
                        o
                }(
                    e,
                    r
            ...
            return !r && a > 1
                ...
                : !(!r && n) && (!!(V(
                    i = r
                        ? i
                        : 1
                ) && o + a > i) && (e.dispatch("DID_THROW_MAX_FILES", {
                    source: t,
                    error: ot("warning", 0, "Max files")
                }), !0))
        },
        ...
        Qr = function (e, t) {
            ...
            o && !e.ref.browser
                ? e.ref.browser = e.appendChildView(
                    e.createChildView(Fn, Object.assign({}, t, {
                        onload: function (t) {
                            Oe("ADD_ITEMS", t, { dispatch: e.dispatch }).then(function (t) {
                                if (Xr(e, t))
                                    return !1;
        ...
        Zr = function (e) {
            var t = e.query("GET_ALLOW_PASTE"),
                ...
                r = t && !n;
            r && !e.ref.paster
                ? (e.ref.paster = Pr(), e.ref.paster.onload = function (t) {
                    Oe("ADD_ITEMS", t, { dispatch: e.dispatch }).then(function (t) {
                        if (Xr(e, t))
                            return !1;
                        e.dispatch("ADD_ITEMS", {
        ...
        $r = S({
            ...
            write: function (e) {
                ...
                if (
                    ...
                    if (u.translateY = Math.max(0, m - u.rect.element.marginTop) - T.top, c) {
                        ...
                        l.scalable = !1;
                        var C = o.fixedHeight - m - (g - T.bottom) - (
                            p
                                ? h
                                : 0
                        );
            ...
            destroy: function (e) {
                ...
                t.ref.paster && t
                    ...
                    t
                        .element
                        .removeEventListener("touchmove", Yr),
                    t
                        .element
                        .removeEventListener("gesturestart", Yr)
            },
            mixins: {
                styles: ["height"]
            }
            ...
            var e = arguments.length > 0 && void 0 !== arguments[0]
                ...
                i = function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1]
                        ...
                        s = function (e) {
                            for (var t, n = arguments.length, r = new Array(
                                n > 1
                                    ? n - 1
                                    : 0
                            ), o = 1; o < n; o++)
            ...
            var p = $r(i, { id: oe() }),
                ...
                v = function (e) {
                    return function (t) {
                        ...
                        return t.items && (n.items = t.items.map(Te)),
                            /progress/.test(e) && (n.progress = t.progress),
                            t.hasOwnProperty("origin") && t.hasOwnProperty("target") && (
                                n.origin = t.origin,
                                n.target = t.target
                            ),
                            n
                ...
                h = function (e) {
                    ...
                    delete t.type,
                        p
                            .element
                            .dispatchEvent(new CustomEvent("FilePond:" + e.type, {
                                detail: t,
                                bubbles: !0,
                                cancelable: !0,
                                composed: !0
                ...
                O = function (e, t) {
                    var n;
                    return "object" != typeof e || (n = e).file && n.id || t || (t = e, e = void 0),
                ...
                y = function () {
                    ...
                    return new Promise(function (e, n) {
                        ...
                        if (P(t[0]))
                            ...
                            var a = t[t.length - 1];
                            "object" != typeof a || a instanceof Blob || Object.assign(o, t.pop()),
                                r
                                    .push
                                    .apply(r, t)
                        }
        ...
        to = function (e) {
            ...
            var i = o
                ...
                .reduce(function (t, n) {
                    var o,
                        i = r(e, n.name);
                    return t[(o = n.name, Vr(o.replace(/^data-/, "")))] = i === n.name || i,
                        t
                }, {});
        ...
        po = (
            Kt = c() && !("[object OperaMini]" === Object.prototype.toString.call(window.operamini)) && "visibilityState" in document && "Promise" in window && "slice" in Blob.prototype && "URL" in window && "createObjectURL" in window.URL && "performance" in window && ("supports" in (window.CSS || {}) || /MSIE|Trident/.test(window.navigator.userAgent)),
            function () {
                return Kt
            }
        ),
    ...
    if (
        ...
        e.Status = Object.assign({}, Me),
            ...
            e.parse = function (t) {
                return Array
                    .from(t.querySelectorAll(".filepond"))
                    .filter(function (e) {
                        return !Eo
                            .apps
                            .find(function (t) {
