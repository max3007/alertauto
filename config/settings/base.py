...
# FILEPOND
# https://django-drf-filepond.readthedocs.io/en/latest/#optional-4-file-storage-configuration
DJANGO_DRF_FILEPOND_UPLOAD_TMP = os.path.join(APPS_DIR, 'media/filepond-temp-uploads')
...
ADMINS = [("""Max307""", "massimo.lupo.mercuri@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "AlertAuto API",
    "DESCRIPTION": "Documentation of API endpoints of AlertAuto",
    "VERSION": "1.0.0",
